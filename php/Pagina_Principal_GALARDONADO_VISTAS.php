<?php
    ...
    while($filas=mysqli_fetch_array($ejecutarVerGalardonados,MYSQLI_BOTH)){
        $filasVerGalardonados.="<tr>
            <td>$filas[6]</td>
            <td>$filas[9]</td>
            <td><i class='fa fa-address-card fa-2x pdf' data-asistente='$filas[0]'></i></td>
            </tr>
        ";
    }
?>
...
<head>
    ...
    <script src="../js/Pagina_Principal_GALARDONADO_VISTAS.js"></script>
...
<div class="contenedor background-color #bdbdbd grey lighten-1">
        <table class="striped responsive-table centered">
            <thead class="background-color red">
                <tr><th>Nombre&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</th><th>Escuela</th><th>Reconocimiento</th></tr>
            </thead>
        </table>
